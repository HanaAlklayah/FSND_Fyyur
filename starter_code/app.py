...
def show_venue(venue_id):
  ...
  '''
  insert into  venue (name, city, state, address, phone, image_link, facebook_link, genres, website, seeking_talent, seeking_description) 
  values ('The Musical Hop','San Francisco','CA', '1015 Folsom Street', '123-123-1234', 'https://images.unsplash.com/photo-1543900694-133f37abaaa5?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=400&q=60', 'https://www.facebook.com/TheMusicalHop', '{Jazz,Reggae,Swing,Classical,Folk}', 'https://www.themusicalhop.com', True, 'We are on the lookout for a local artist to play every two weeks. Please call us.');
  ...
  values ('The Dueling Pianos Bar','New York','NY', '335 Delancey Street', '914-003-1132', 'https://images.unsplash.com/photo-1497032205916-ac775f0649ae?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=750&q=80', 'https://www.facebook.com/theduelingpianos', '{Classical,R&B,Hip-Hop}', 'https://www.theduelingpianos.com', False);
...
def show_artist(artist_id):
  ...
  '''
  insert into  artist (name, city, state, phone, genres, image_link, facebook_link) 
  values ('Guns N Petals','San Francisco','CA', '326-123-5000', '{Rock n Roll}', 'https://images.unsplash.com/photo-1549213783-8284d0336c4f?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=300&q=80', 'https://www.facebook.com/GunsNPetals');
  data1={
    "id": 4,
    "name": "Guns N Petals",
    "genres": ["Rock n Roll"],
